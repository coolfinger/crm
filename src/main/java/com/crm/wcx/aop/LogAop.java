...
public class LogAop {
	 ...
	 * 
	* @Title: afterReturing 
	* @Description: @AfterReturning("log()") 
	* @param joinPoint void
	* @author ColdFingers
	* @date 2018年12月4日下午1:06:08
	 */
	 ...
	 * 
	* @Title: afterThrowing 
	* @Description: @AfterThrowing(pointcut="log()", throwing="e") 
	* @param joinPoint
	* @param e void
	* @author ColdFingers
	* @date 2018年12月4日下午1:06:19
	 */
