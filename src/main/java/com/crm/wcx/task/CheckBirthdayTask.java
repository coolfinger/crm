...
import com.crm.wcx.entity.CustomerCareExample.Criteria;
...
/**
 * 
 * @ClassName: CheckBirthdayTask 
 * @Description: 用于定义检测联系人是否已经快到了
 * @author: ColdFingers
 * @date: 2018年12月4日 下午1:03:14
 */
@Component
public class CheckBirthdayTask {
     ...
     * 
    * @Title: checkBirthday 
    * @Description: 用于检测用户的生日是否在30天内，每天零点检查一次  void
    * @author ColdFingers
    * @date 2018年12月4日下午1:03:23
     */
