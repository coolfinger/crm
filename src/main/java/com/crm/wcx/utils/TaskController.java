...
public class TaskController {
	...
	* @Description: 检查客户流失  计算距离上一下下单时间超过 6 个月就自动添加到客户流失表
	* @author CoolFingers
	* @date 2018年11月10日上午10:14:41
	 */
	...
	public void checkCustomerLoss(){
		...
		for (Orders o : orders) {
			if(o.getDate() != null){
				 ...
				 */
				Duration duration = Duration.between(o.getLocalTimeDate(), LocalDateTime.now());
	...
	public void insertCustomerLoss(Orders orders){
		...
		loss.setLastOrderTime(orders.getLocalTimeDate());
		loss.setStatus("0");
		/**
