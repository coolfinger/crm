        ...
        <!--<i class="layui-icon">&#xe613;</i>
          ...
          <div class="layui-form-item">
			...
			<div class="layui-input-block" style="width: 250px;">
			  <input name="account" type="text" lay-verify="required" placeholder="登录帐号(admin)" autocomplete="off" class="layui-input">
          ...
          <div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 250px;">
			  <input name="password"  type="password" lay-verify="required" placeholder="登录密码(admin)" autocomplete="off" class="layui-input">
